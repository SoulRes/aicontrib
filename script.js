...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('buy-btn').addEventListener('click', function() {
        ...
        if (paymentMethod === 'trc20') {
            alert('You selected TRC-20 payment method. Proceeding to checkout.');
    ...
    // Function to handle the TRC-20 payment process
    function processTRC20Payment() {
        // Placeholder logic for processing TRC-20 payments
        // You can integrate with NOWPayments API here
        console.log('Processing TRC-20 payment...');
        // Example: Call the API or redirect to the payment gateway
    }
